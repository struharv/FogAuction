...
serialized = {
"nodes": [
	{"name": "n1", "resources": {"memory":10, "storage":100}, "deployed": [{"task": "T1", "application":"app1"}]},
...
nodeX = AuctioningNode("nx", {"memory":10, "storage":1000})
node1 = AuctioningNode("n1", {"memory":26, "storage":1000})
node2 = AuctioningNode("n2", {"memory":15, "storage":1000})
node3 = AuctioningNode("n3", {"memory":150, "storage":1000})
